...
public class BNEF extends BranchF
{
    public BNEF(int row, TAC instr, Map<String, Integer> look)
    {
    ...
    public static List<Block> comp1(int row, int col, int dist)
    {
        ...
        blocks.add(new Chain(row, col, "execute unless " + C0 + "=" + C1 + dist + " ~1 ~" + -col + " redstone_block"));
    ...
    {
        return BNEF.comp1(row, col, dist);
    }
}
